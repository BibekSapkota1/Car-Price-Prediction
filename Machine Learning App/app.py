...
# # # Load models
# # models = {
# #    #  "XGBoost Error": joblib.load("xgb_model.pkl"),
...
# #     model_choice = st.radio("Choose a model:", ["Main Model (Average)"] + list(models.keys()))
...
# with st.sidebar:
#     st.header("Select Prediction Model")
#     model_choice = st.radio("Choose a model:", ["Ensemble Model"] + list(models.keys()))
